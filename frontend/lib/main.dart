...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> fetchAll() async {
    ...
    try {
      ...
      final cRes =
          await http.get(Uri.parse('$backendBase/api/categories'), headers: headers);
      final pRes =
          await http.get(Uri.parse('$backendBase/api/products'), headers: headers);
      final promoRes =
          await http.get(Uri.parse('$backendBase/api/promotions'), headers: headers);
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: ListView(
                        ...
                        children:
                            categories.map<Widget>((c) => buildCategoryChip(c)).toList(),
                      ),
                    ),
                    SizedBox(height: 18),
                    Row(
                    ...
                    Container(
                      ...
                      child: ListView(
                        scrollDirection: Axis.horizontal,
                        children:
                            products.map<Widget>((p) => buildProductCard(p)).toList(),
                      ),
                    ),
                  ],
                ),
